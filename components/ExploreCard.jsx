...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    className={`relative ${active === id ? 'flex-[10] lg:flex-[3.5]' : 'flex-[2] lg:flex-[0.5]'} 
  ...
  >
    ...
    {active !== id
      ? (
        <h3 className="font-semibold text-[18px] sm:text-[26px] text-white
