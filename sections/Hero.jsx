    ...
    <motion.div
      ...
      <motion.div
        ...
        <div className="absolute w-full h-[300px] hero-gradient rounded-tl-[140px] z-[0] -top-[30px]" />
          <Image src="/cover.png" alt="cover" width={754} height={350} quality={100} className="w-full h-[350px] sm:h-500px object-cover rounded-tl-[140px] z-10 relative" />
          <a href="#explore">
            <div className="w-full flex justify-end -mt-[50px] pr-[40px] relative z-10 sm:-mt-[70px]">
